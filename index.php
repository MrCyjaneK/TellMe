...
if (isset($_GET['name'])) {
	include 'config.php';
	contact($_GET['name'],$_GET['email'],$_GET['message']);
	echo "<script>alert('Message sent! Give me up to 24 hours to reply')</script>";
}
?>
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form">
				...
				<!--<div class="wrap-input100 input100-select bg1">
					<span class="label-input100">How can I help you?</span>
					<div>
